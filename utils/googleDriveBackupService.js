...
import { exportDatabase, importDatabase } from "../src/db/query/googleDrive";
import { getSetting, setSetting } from "../src/db/query/settings";

const FILE_NAME = "Zeniamoney_Backup.json";

export const configureGoogleDrive = () => {
  GoogleSignin.configure({
    scopes: ["https://www.googleapis.com/auth/drive.file"],
    webClientId: "971359215487-bf9h17j1k4l65k659945uudk6krkhdgu.apps.googleusercontent.com",
    offlineAccess: true,
  });
};
